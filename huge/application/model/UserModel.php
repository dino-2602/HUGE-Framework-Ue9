...
class UserModel
{
    ...
    public static function getPublicProfileOfUser($user_id)
    {
        ...
        $sql = "SELECT user_id, user_name, user_email, user_active, user_has_avatar, user_deleted, user_groups
    ...
    public static function getAccountTypeLong($type = null)
    {
        ...
        $query = $database->prepare("SELECT group_name FROM user_groups
                                 WHERE group_name = :group_name");

        $query->execute(array(':group_name' => $type));
    ...
    public static function getAvailableAccountTypes()
    {
        ...
        $query = $database->prepare("SELECT * FROM user_groups");
     ...
     * Implementation because of the new messenger feature
     *
     * @param $user_id
     *
     * @return mixed Returns false if user does not exist, returns object with user's data when user exists
